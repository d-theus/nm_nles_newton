...
Многие задачи физики и математики сводятся к решению систем нелинейных уравнений. При этом очень часто аналитическое решение не требуется, достаточно вычмслить решения с какой-нибудь точностью.
\newpage
\section*{Определения}
